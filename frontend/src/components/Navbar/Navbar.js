                ...
                <nav className={expanded ? '' : 'hidden'}>
                    <div className="flex flex-col pt-8 pb-4 space-y-6">
                        ...
                        <div className="relative inline-flex items-center justify-center group ">
                            ...
                            <a href="myProjects" title="" className="relative inline-flex items-center justify-center w-full px-6 py-2 text-base font-normal text-white bg-black border border-transparent rounded-full " role="button"> My Projects </a>
                        </div>
                    </div>
                </nav>
            </div>
